...
<form name="frmBeveragelist" id="frmBeveragelist" action="./pop_branch_template_write_update.php" onsubmit="return frmBeveragelist_submit(this);" method="post">
			...
			<div class="tbl_head01 tbl_wrap">
				...
				<tr>
					<td class="td_chk">
						...
						<input type="hidden" name="data_cd[<?php echo $i ?>]" value="<?php echo $row['beverage_cd'] ?>" id="beverage_cd<?php echo $i ?>">
					</td>
					<td class="td_category"><?php echo $row['beverage_cd']?></td>
					<td class="td_category"><?php echo get_code_name($row['beverage_cate'])?></td>
					<td class="td_addr"><?php echo $row['beverage_kor_nm']?></td>
				</tr>
				<?php
				}
				if ($i == 0)
