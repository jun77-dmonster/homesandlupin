...
<form name="frmBranch" method="post" action="./branch_questions_register_update.php" onsubmit="return frmBranchChk(this)" enctype="multipart/form-data">
	...
	<div class="box-cont">
		...
		<tr>
			...
			<td>
				...
				<option value="board_game" <?php echo ($row['qna_gubun']=="board_game")?"selected":""?>>게임</option>
				<option value="beverage" <?php echo ($row['qna_gubun']=="beverage")?"selected":""?>>식음료</option>
				<option value="common" <?php echo ($row['qna_gubun']=="common")?"selected":""?>>운영</option>
				</select>
				</div>
			</td>
		</tr>
