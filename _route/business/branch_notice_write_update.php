...
$notice_gubun		=	isset($_POST['notice_gubun']) ? trim($_POST['notice_gubun']) : '';
$notice_category	=	isset($_POST['notice_category']) ? trim($_POST['notice_category']) : '';

if (isset($_POST['notice_title'])) {
    $wr_subject = substr(trim($_POST['notice_title']),0,255);
    $wr_subject = preg_replace("#[\\\]+$#", "", $wr_subject);
}

if (isset($_POST['notice_content'])) {
    $wr_content = substr(trim($_POST['notice_content']),0,65536);
...
if($w==""){
	...
	//등록
	$sql = " insert into {$DM['NOTICE_TABLE']} 
				set notice_gubun		=	'{$notice_gubun}',
					notice_category		=	'{$notice_category}',
					notice_title		=	'{$wr_subject}',
					notice_content		=	'{$wr_content}',
...
goto_url("./branch_notice_write.php?w=u&uid=".$uid);