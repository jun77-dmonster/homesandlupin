...
<div class="layer-popup">
	...
	<div class="wrapper type-1200">
		...
		<div class="content-bottom-wrap2">
			...
			<form name="fPopBranchGamelist" id="fPopBranchGamelist" action="./pop_branch_games_recommend_register_update.php" onsubmit="return fPopBranchGamelist_submit(this);" method="post">
				...
				<div class="inner-table-wrap type-2 scroll">
					...
					<div class="table-tit-area2">
						...
						<div class="btn-wrap-right marB20">
							...
							<button type="button" class="crmBtn type-white" onclick="location.href='./pop_branch_game_recommend_list.php?branch_cd=<?php echo $branch_cd?>'"><?php echo $branch_info['branch_nm']?> 등록된 게임 목록</button>
