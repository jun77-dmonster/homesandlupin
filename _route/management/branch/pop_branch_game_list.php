...
$sql_search = " where t1.branch_cd='{$branch_info['branch_cd']}' and t1.branch_use_fl='T' ";
	...
	<div class="wrapper type-1200">
		...
		<div class="container-wrap">
			...
			<div class="box-view-wrap">	
				...
				<div class="view-title"><?php echo $branch_info['branch_nm']?> 등록된 게임 : <?php echo $total_count;?> 건</div>

				
				<div class="content-bottom-wrap2">

				<form name="fPopBranchGamelist" id="fPopBranchGamelist" action="./pop_branch_game_list_update.php" onsubmit="return fPopBranchGamelist_submit(this);" method="post">
						...
						<div class="inner-table-wrap type-2 scroll">
							...
							<div class="table-tit-area2">
								...
								<div class="btn-wrap-right marB20">
									...
									<button type="button" class="crmBtn type-white" onclick="location.href='./pop_branch_games_register.php?branch_cd=<?php echo $branch_cd?>'">신규 게임 등록</button>
