		...
		<tr>
			...
			<td>
				<select class="small" name="sfl" style='width:200px;'>
					<option value="beverage_kor_nm" <?php echo ($sfl=="beverage_kor_nm")?"selected":""?>>세트이름(한글)</option>
					<option value="beverage_eng_nm" <?php echo ($sfl=="beverage_eng_nm")?"selected":""?>>세트이름(영문)</option>
				</select>
...
<form name="beverageList" id="beverageList" action="./setmenu_list_update.php" onsubmit="return beverageList_submit(this);" method="post">
	...
	<div class="mall-products-view">
		...
		<div class="mall-orders-view">
			...
			<div class="table-tit-area">
				...
				<span class="table-tit">등록된 세트 <span class="num"><?php echo $total_count?></span> 건</span>
			...
			<div class="content_item_bx">
				...
				<div class="tbl_head01 tbl_wrap">
					...
					for ($i=0; $row=sql_fetch_array($result); $i++) {
						$s_mod = "<a href='./setmenu_register.php?w=u&amp;beverage_cd={$row['beverage_cd']}' class='board_copy btn btn_02'>수정</a>";
...
<div class="btn_fixed_top">
    <a href="./setmenu_register.php?<?php echo $qstr ?>" class="btn btn_01">신규 세트메뉴 등록</a>
</div>
...
function beverageList_submit(f){
    ...
    if(document.pressed == "선택삭제") {
        if(!confirm("선택한 세트메뉴를 정말 삭제시키겠습니까?\n\n삭제되면 모든 지점에서 주문할수 없게 됩니다")) {
            return false;
        }
    }
