...
<form name="frmBeverageGame" method="post" action="./setmenu_register_update.php" onsubmit="return frmBeverageGameChk(this)" enctype="multipart/form-data">
...
<div class="btn_fixed_top">
    <a href="./setmenu_list.php?<?php echo $qstr ?>" class="btn btn_02">목록</a>
