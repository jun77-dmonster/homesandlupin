...
if ((! (isset($mb['manager_id']) && $mb['manager_id']) || !route_password_check($mb, $mb_password, $mb['manager_pw'])) ) {
...
// 회원아이디 세션 생성
set_session('ss_manager_id', $mb['manager_id']);
// FLASH XSS 공격에 대응하기 위하여 회원의 고유키를 생성해 놓는다. 관리자에서 검사함 - 110106
set_session('ss_manager_key', md5($mb['manager_reg_dt'] . get_real_client_ip() . $_SERVER['HTTP_USER_AGENT']));
