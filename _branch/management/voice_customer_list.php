...
$sql_search = " where (1) and customer_delete_fl='F' and branch_cd='{$branch['branch_cd']}' ";
...
$colspan = 8;
?>
<form name="voicelist" id="voicelist" action="./voice_list_update.php" onsubmit="return voicelist_submit(this);" method="post">
