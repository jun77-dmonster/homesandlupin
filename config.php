...
define('G5_ROUTE_DIR',      '_route');
define('G5_BRANCH_DIR',     '_branch');
...
define('G5_ROUTE_URL',      G5_URL.'/'.G5_ROUTE_DIR);
define('G5_BRANCH_URL',     G5_URL.'/'.G5_BRANCH_DIR);
...
define('G5_ROUTE_PATH',     G5_PATH.'/'.G5_ROUTE_DIR);
define('G5_BRANCH_PATH',    G5_PATH.'/'.G5_BRANCH_DIR);
